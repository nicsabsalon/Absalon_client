								...
								<TabGroup as="div" class="mt-2">
									...
									<TabPanels as="template">
										<TabPanel v-for="(category, categoryIdx) in navigation.categories"
											:key="category.name" class="space-y-12 px-4 pb-6 pt-10">
													...
													<div>
														...
														<ul role="list"
															...
															<li v-for="item in category.featured" :key="item.name"
																class="flex">
																<a :href="item.href" class="text-gray-500">{{ item.name
																}}</a>
															</li>
														</ul>
													</div>
																		...
																		<div class="grid grid-cols-2 gap-x-8 gap-y-10">
																			<div>
																				...
																				<ul role="list"
																					...
																					<li v-for="item in category.featured"
																			...
																			<div>
																				...
																				<ul role="list"
																					...
																					class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
																					<li v-for="item in category.categories"
																						:key="item.name" class="flex">
																						<a :href="item.href"
																							class="hover:text-gray-800">{{
																								item.name }}</a>
			...
			<main>
				<div class="bg-white">
					<div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
						...
						<p class="mt-4 max-w-xl text-sm text-gray-700">Our thoughtfully designed workspace objects are
							crafted in
							limited runs. Improve your productivity and organization with these sale items before we run
							out.</p>
					</div>
				</div>
